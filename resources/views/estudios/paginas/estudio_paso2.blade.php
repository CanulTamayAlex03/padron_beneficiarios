...
<div class="card mt-4">
    ...
    <div class="card-body">
        @php
            ...
            $puntosElectricidad = $estudio->electricidad == 0 ? 3 : 0; // Cambiado de 1 a 3 puntos
            ...
            $puntosRazon = ($estudio->razon_mayor == 1) ? 3 : 0; // Cambiado de 2 a 3 puntos
            ...
            $maximoPuntos = 21; // 7 preguntas × 3pts = 21 puntos
        @endphp
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (inputCuartos) {
        inputCuartos.addEventListener('input', function() {
            ...
            const razon = cuartos > 0 ? (numPersonas / cuartos).toFixed(2) : 0;
            razonField.value = razon;

            // Autoajuste: si la razón supera 2.5, selecciona automáticamente "Sí"
            if (razon > 2.5) {
                razonSelect.value = "1";
            } else {
                razonSelect.value = "0";
