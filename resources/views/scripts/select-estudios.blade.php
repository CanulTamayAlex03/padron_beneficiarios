...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function obtenerEstadoEstudio(estudio) {
        if (estudio.res_estudio_1 && estudio.res_estudio_2 && estudio.res_estudio_3) {
            return { texto: 'Completo', clase: 'bg-success' };
        } else if (estudio.res_estudio_1 || estudio.res_estudio_2 || estudio.res_estudio_3) {
            return { texto: 'En progreso', clase: 'bg-warning' };
        } else {
            return { texto: 'Incompleto', clase: 'bg-secondary' };
        }
    }
});
</script>
